...
from tab_benchmark.models.dnn_models import TabBenchmarkSaint


classifier = TabBenchmarkSaint
regressor = TabBenchmarkSaint
kwargs = dict(max_epochs=2, batch_size=10, embedding_dim=2, n_heads=1)
