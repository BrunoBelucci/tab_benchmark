...
from tab_benchmark.utils import extends, sequence_to_list
...
def dnn_factory(architecture_cls, create_search_space_fn, get_recommended_params_fn):
    ...
    dnn_model_parameters = signature(DNNMixin.__init__).parameters
    ...
    class TabBenchmarkDNN(DNNMixin, TabBenchmarkModel, DNNModel):
        @merge_and_apply_signature(merge_signatures(signature(DNNMixin.__init__), signature_dnn_model,
