...
from tabular_benchmark.utils.pytorch_tabnet.tab_network import TabNetDecoder
from tabular_benchmark.utils.pytorch_widedeep.tabular import TabNet, TabMlp, TabResnet, TabMlpDecoder, TabResnetDecoder
from tabular_benchmark.utils.pytorch_widedeep.tabular.self_supervised._random_obfuscator import (
    RandomObfuscator,
)
...
class EncoderDecoderModel(nn.Module):
    ...
    def _build_tabmlp_decoder(self):
        common_params = (
    ...
    def _build_tabresnet_decoder(self):
        common_params = (
    ...
    def _build_tabnet_decoder(self):
        common_params = (
