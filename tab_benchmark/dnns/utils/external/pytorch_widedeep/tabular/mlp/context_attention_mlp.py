...
from tabular_benchmark.utils.pytorch_widedeep.tabular.mlp._encoders import (
...
class ContextAttentionMLP(BaseTabularModelWithAttention):
    ...
    See `tabular_benchmark.utils.pytorch_widedeep.tabular.mlp._attention_layers` for details.
