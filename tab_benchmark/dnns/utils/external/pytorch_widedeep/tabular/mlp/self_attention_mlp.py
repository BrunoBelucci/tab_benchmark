...
from tabular_benchmark.utils.pytorch_widedeep.tabular.mlp._encoders import SelfAttentionEncoder
...
class SelfAttentionMLP(BaseTabularModelWithAttention):
    ...
    `tabular_benchmark.utils.pytorch_widedeep.tabular.mlp._attention_layers` for details. The
