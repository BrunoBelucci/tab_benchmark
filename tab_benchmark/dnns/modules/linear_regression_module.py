...
#     """
#     def __init__(self, model_class, architecture_params, optimizer_fn, optimizer_kwargs, loss_fn,
#                  scheduler_fn=None, scheduler_kwargs=None, scheduler_config=None):
#         super().__init__(dnn_architecture_class=model_class, architecture_params=architecture_params,
